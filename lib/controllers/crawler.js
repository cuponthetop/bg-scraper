...
CrawlerController.prototype.doCrawl = function (crawlFunc, arg) {
    ...
    case 'price': {
      chainedFunc = function (prices) {
        return Promise.all(_.map(prices, function (price) {
          return this.gameMgr.addPrice.call(this, jobtype, price)
        }.bind(this)))
    ...
    case 'post': {
      chainedFunc = function (posts) {
        return Promise.all(_.map(posts, function (post) {
          return this.postMgr.addPost.call(this, jobtype, post);
        }.bind(this)))
