...
GameController.prototype.addGameSearchTerm = function (req, res) {
  ...
  req.checkBody('type', 'Invalid Market Type for Search TermsEl').isNotEmpty().isAlphanumeric();
...
GameController.prototype.removeGameName = function (req, res) {
  req.checkParams('alias', 'Invalid Gamename Alias').isNotEmpty().isAlphanumeric();
...
GameController.prototype.removeGameSearchTerm = function (req, res) {
  req.checkParams('type', 'Invalid Market Type for Search TermsEl').isNotEmpty().isAlphanumeric();
...
GameController.prototype.removeGameURL = function (req, res) {
  req.checkParams('type', 'Invalid Market Type').isNotEmpty().isAlphanumeric();
