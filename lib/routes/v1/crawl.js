...
module.exports = function (controllers) {
  ...
  crawler.post('/once/:jobtype', function (req, res) {
    ...
    req.getValidationResult().then(function (result) {
      ...
      crawlerCTRL.getJobInfo(req.params.jobtype, additionalData).then((jobInfo) => {
        crawlerCTRL.crawlOnce(req.params.jobtype, jobInfo.crawlFunc, jobInfo.chainedFunc, jobInfo.args)
          .then((result) => {
